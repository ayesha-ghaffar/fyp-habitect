...
class MyApp extends StatefulWidget { // Changed to StatefulWidget to manage Auth listener
  ...
  void _setupFirebaseAuthListener() {
    _auth.authStateChanges().listen((User? user) async {
      ...
      if (user != null) {
        ...
        // You might also fetch FCM token here and update it
        ...
        // If a user logs out, we also set their status to offline
        // This is a bit tricky if multiple devices, but generally good practice
        // For simplicity, we assume the last logged out user goes offline.
        // A more robust solution involves Firebase functions for onDisconnect.
        // For now, onDisconnect is handled in UserService updateOnlineStatus.
      }
    });
  }
